...
class Ion_auth
{
	...
	public function logged_in()
	{
		...
		if (!$recheck AND get_cookie($this->config->item('remember_cookie_name', 'ion_auth')))
		{
	...
	protected function check_compatibility()
	{
		...
		if (!function_exists('random_bytes') AND !function_exists('mcrypt_create_iv') AND !function_exists('openssl_random_pseudo_bytes'))
		{
