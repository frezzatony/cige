...
class Number_filter extends Filter_inputs_defaults
{
    ...
    public function getOptionsInput($variable = array()){
        ...
        return array(
            ...
            'data-operators'    =>  'equal_number,between,greater,greater_or_equal,less,less_or_equal,not_between,not_equal,notnull',
        );
    }
      /**
     * PRIVATES
