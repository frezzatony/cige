...
class Unidades_familiares_relatorio_model extends CI_Model{
    ...
    public function getDataCadastro_Emhab($arrProp = array()){
        ...
        $sql =  '
            WITH 
                ...
                integrantesUnidadeFamiliar.necessidade_especial_descricao AS necessidade_especial_descricao_integrante, integrantesUnidadeFamiliar.remuneracao_ocupacoes AS remuneracao_ocupacoes_integrante
