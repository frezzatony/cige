...
class Produtos_cadastros_controller extends Data{
    ...
    function __construct(Cadastros $cadastro){
        ...
        if($this->cadastro->get('token.depositos_id') AND is_array($this->cadastro->get('token.depositos_id'))){
            $this->cadastro->set('filters',
                array(
                    array(
                        'id'        =>  'id',
                        'clause'    =>  'in_integer',
                        'value'     =>  $this->cadastro->get('token.depositos_id'),
                    )
                )
            );
        }      
