                        ...
                        'children'  =>  array(
                            array(
                                ...
                                'children'  =>  array(
                                    $formDocumentos['form'],
                                    array(
                                        'text'      =>  $this->CI->template->load('jquery',NULL,'Blank_view',array('javascript'=>($formDocumentos['javascript']??NULL)),TRUE),
                                    )    
                                )
                            )
                        )
                        ...
                        'children'  =>  array(
                            array(
                                ...
                                'children'  =>  array(
                                    $formDadosCivis['form'],
                                    array(
                                        'text'      =>  $this->CI->template->load('jquery',NULL,'Blank_view',array('javascript'=>($formDadosCivis['javascript']??NULL)),TRUE),
                                    )    
                                )
                            )
                        )
