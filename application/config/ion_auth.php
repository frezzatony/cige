...
*/
$config['tables']['users']           = 'usuarios.usuarios';
$config['tables']['groups']          = 'usuarios.grupos';
$config['tables']['users_groups']    = 'usuarios.usuarios_grupos';
$config['tables']['login_attempts']  = 'usuarios.login_attempts';
...
$config['maximum_login_attempts']     = NULL;                   // The maximum number of failed login attempts.
