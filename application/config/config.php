...
$config['em_atualizacao'] = FALSE;
$config['ips_atutorizados_em_atualizacao'] = array(
    '192.168.6.1'
);

$config['log_acesso'] = TRUE;
...
$config['composer_autoload'] = 'third_party/vendor/autoload.php';
...
|
*/
$config['encryption_key'] = '83§60)ay$gAE6FvZ7dgRKX2OO6i20k;jrEF3x9j@_';
...
$config['sess_table_name']		= 'sistema.ci_sessions';
$config['sess_match_ip']		= FALSE;
