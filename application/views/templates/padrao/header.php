...
<html lang="pt-br">
    <head>        
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL;?>assets/css/style.css?v=1.9.2">
        <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL;?>assets/css/mainmenu.css?v=1.9.2">
        <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL;?>assets/css/responsive.css?v=1.9.2">
        <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL;?>assets/css/utils.css?v=1.9.2">
