...
(function($) {
    ...
    // options for months
    var str_opt_month = "";
    var months = ["Janeiro", "Fereveiro", "Março", "Abril",
    ...
    var pediodsName = ["minuto", "hora", "dia", "semana", "mês", "ano"]; 
    for (var i = 0; i < periods.length; i++) {
        str_opt_period += "<option value='"+periods[i]+"'>" + pediodsName[i] + "</option>\n";
    }
    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "A cada <select class='input-sm bordered' style='width: 150px;' name='cron-period'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " todo dia <select class='input-sm bordered' style='width: 60px;' name='cron-dom'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + " mês  <select class='input-sm bordered' style='width: 100px;' name='cron-month'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + " no minuto <select class='input-sm bordered' style='width: 60px;' name='cron-mins'>" + str_opt_mih
                    + "</select> de cada hora </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " dia <select class='input-sm bordered' style='width: 100px;' name='cron-dow'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + " no hora <select class='input-sm bordered cron-time-hour' style='width: 60px;' name='cron-time-hour' >" + str_opt_hid
                    + "</select>:<select class='input-sm bordered cron-time-min' style='width: 60px;'  name='cron-time-min' >" + str_opt_mih
                    + " </span>")
                .appendTo(this)
                .data("root", this);
